...
public class StatusCalendarView extends View {
    ...
    private StatusCalendarController compactCalendarController;
    private GestureDetectorCompat gestureDetector;
    private boolean shouldScroll = true;

    public interface StatusCalendarViewListener {
    ...
    public interface StatusCalendarAnimationListener {
    ...
    public StatusCalendarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StatusCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        compactCalendarController = new StatusCalendarController(new Paint(), new OverScroller(getContext()),
    ...
    public void setAnimationListener(StatusCalendarView.StatusCalendarAnimationListener compactCalendarAnimationListener) {
        animationHandler.setStatusCalendarAnimationListener(compactCalendarAnimationListener);
    }
    ...
    public void setListener(StatusCalendarView.StatusCalendarViewListener listener) {

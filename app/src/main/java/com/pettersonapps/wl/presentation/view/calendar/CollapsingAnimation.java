...
class CollapsingAnimation extends Animation {
    ...
    private final StatusCalendarView view;
    private int targetGrowRadius;
    private final boolean down;
    private StatusCalendarController compactCalendarController;

    public CollapsingAnimation(StatusCalendarView view, StatusCalendarController compactCalendarController, int targetHeight, int targetGrowRadius, boolean down) {
        this.view = view;
